...
namespace MedicalExamination.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            ViewBag.Roles = new SelectList(db.Roles.Where(a => !a.Name.Contains("Admin") && !a.Name.Contains("Guest") && !a.Name.Contains("دكتور")).ToList(),
                                                          "Name", "Name");      
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await SignInManager.SignInAsync(patient, isPersistent:false, rememberBrowser:false);
        ...
        public ActionResult EditeProfile()
        {
            ...
            profile.UserName = patient.UserName;
        ...
        public ActionResult QEditeProfile(EditProfileViewModel profile)
        {
            ...
            var patientId = User.Identity.GetUserId();
            var patient = db.Patients.Where(x => x.Id == patientId).SingleOrDefault();
            if (!UserManager.CheckPassword(patient, profile.CurrentPassword))
            {
                ViewBag.Message = "كلمة السر غير صحيحة";
            }
            else
            {
                patient.UserName = profile.UserName;
                patient.Email = profile.Email;
                patient.Gender = profile.Gender;
                patient.PhoneNumber = profile.PhoneNumber;
                patient.BirthDate = profile.BirthDate;
                patient.CityId = profile.CityId;
            ...
            return RedirectToAction("GetPostsbyPatient","Patients");
        }
